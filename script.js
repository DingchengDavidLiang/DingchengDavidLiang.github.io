...
const skillDescriptions = {
  Systems: 'Connect engineering judgment, repeatable rules, data, and tools into one working system.',
  Build: 'Turn constraints and requirements into practical engineering and design solutions.',
  Measure: 'Translate drawings and scope into quantities, estimates, and decisions.',
  Automate: 'Reduce repetitive work with Excel, AI, code, QA logic, and reusable workflows.',
  Visualize: 'Make complex information easier to understand through drawings, models, and visual communication.',
  Connect: 'Bring people, projects, sponsors, and stakeholders together to make ideas happen.'
};
